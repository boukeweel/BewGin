#include "HealthTextObserver.h"

#include "GameObject.h"
#include "HealthComponent.h"

dae::HealthTextObserver::HealthTextObserver(TextComponent* pTextComponent) : m_TextComponent{pTextComponent}
{
	//to set the first base text
	m_livesTxt = m_TextComponent->getText();
}

void dae::HealthTextObserver::Notify(GameEvents event, GameObject* gameObject)
{
	switch (event)
	{
